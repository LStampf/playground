...
public class RatingServiceImpl implements RatingService {
	...
	private static Logger LOGGER = Logger.getLogger(RatingServiceImpl.class.getName());
	...
	public Rating getCustomerRating(Long id) {
		...
		LOGGER.info("Customer(" + id + ") has rating " + c.getRating().toString());
		return c.getRating();
	}
	...
	public Rating getWarrantorRating(Long id) {
		...
		LOGGER.info("Warrantor(" + id + ") has rating " + w.getRating().toString());
		return w.getRating();
	}
